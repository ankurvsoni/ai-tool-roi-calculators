...
export default function Pricing(){
  ...
  </div><p className="footer">Intro launch pricing. We may increase pricing after first 10 customer outcomes.</p><p className="muted">Fastest path: pay via Stripe above. <Link href="/audit">Use intake form only for custom scope requests.</Link></p></main>
}
